...
@sched.scheduled_job('cron', hour='06', minute='00', id='get_weather_api')
def job():
    get_time = (datetime.today() - timedelta(1)).strftime("%Y%m%d")
    print(f' {time.strftime("%H:%M:%S")} get api ')
